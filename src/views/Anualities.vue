<template>
                  ...
                  <ion-list>
                      <ion-row>
                          <ion-col size="12">
                              <ion-item>
                                  ...
                                  <ion-input type="number" v-model="presentValue" aria-label="Present Value (PV)"></ion-input>
                              </ion-item>
                          </ion-col>
                      </ion-row>
                      ...
                      <ion-row>
                          <ion-col size="12" class="ion-text-center">
                              <ion-button color="dark" size="default" expand="block" @click="calculateAnnualities()">Calculate Annuities</ion-button>
                          </ion-col>
                      </ion-row>
                      ...
                      <ion-row>
                          <ion-col size="12">
                              <ion-item>
                                  <ion-label position="stacked">Annuities (A)</ion-label>
                                  <ion-input :value="annuality" disabled aria-label="Annuities (A)"></ion-input>
                              </ion-item>
                          </ion-col>
                      </ion-row>
                  </ion-list>
  ...
  export default defineComponent ({
      ...
      methods: {
          calculateAnnualities() {
              this.inputError = false;
              
              if (this.presentValue === 0 || this.interestRate === 0 || this.frequency === 0 || this.periods === 0) {
                  this.inputError = true;
                  return;
              }
  
              this.convertedInterestRate = (this.interestRate / this.frequency) / 100;
                this.annuality = this.presentValue * (this.convertedInterestRate / (1 - Math.pow((1 + this.convertedInterestRate), -this.periods)));
          }
      }
  });
  </script>
